...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 30 15:42:36 2019

@author: https://www.kaggle.com/emptycasket/regression-with-svm-python-2#Goal
"""
...
#import os
#dirpath = os.getcwd()
dirpath = "/home/q/Seafile/teaching/teach/jose/randomForests/minicompetitionHouseprices"

## Load data
train = pd.read_csv(dirpath + '/input/train.csv')
test = pd.read_csv(dirpath + '/input/test.csv')
